...
class MinResolutionExseption(Exception):
    pass


class MaxResolutionExseption(Exception):
    pass
...
class Product(models.Model):
    ...
    #         raise MinResolutionExseption('Слишком маленькое изображение')
    #     elif img.width > max_width or img.height > max_height:
    #         raise MaxResolutionExseption('Слишком большое изображение')
...
class Notebook(Product):
    ...
    time_without_charge = models.SmallIntegerField(verbose_name='Вребя работы аккумулятора', default=0,
                                                   help_text='Укажите время в часах')
...
class Smartphone(Product):
    ...
    processor_freq = models.CharField(max_length=255, verbose_name='Частота процессора')
    sd = models.BooleanField(default=True, verbose_name='Наличия SD карти')
    sd_volume_max = models.CharField(max_length=255, null=True, blank=True,
                                     verbose_name='Максимальный объем втроенной памяти')
    ram = models.CharField(max_length=255, verbose_name='Оперативная память')
    main_can_np = models.CharField(max_length=255, verbose_name='Главная камера')
    frontal_can_np = models.CharField(max_length=255, verbose_name='Фронтальная камера')
